...
# --- CONFIGURAZIONE ---
dataset_path = "/home/lorenzo/Desktop/TESI/LPSO/dataset"
output_path = "/home/lorenzo/Desktop/Grafici"

atom1 = "Li"
atom2_list = ["S"]  # Lista coppie da analizzare
...
if __name__ == "__main__":
    ...
    if all(len(all_distances[atom2]) == 0 for atom2 in atom2_list):
        ...
        for atom2 in atom2_list:
            ...
            plt.plot(bin_edges[:-1], hist_smooth, label=f'Distribuzione {atom1}-S')
        ...
        filename = f"Distribuzione_minima_{atom1}_S.png"
